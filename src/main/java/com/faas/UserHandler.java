...
public class UserHandler implements Route {
    ...
    private Object handleAct(Request request, Response response) throws Exception {
        Object requestAct = handleRquestParams(request);
        ...
        if (resAct == null) {
            ...
            return convertByFaaSResponse(response, (FaaSResponse) resAct);
    ...
    private static Object convertByFaaSResponse(final Response response, final FaaSResponse resAct) {
        FaaSResponse res = resAct;
    ...
    private Object handleRquestParams(Request request) throws IOException {
        // 入参处理
        Object requestAct;
